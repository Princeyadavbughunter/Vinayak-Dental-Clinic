  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="bg-[#2364a5] p-6 text-center">
        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-[#2364a5] font-medium mb-4">
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              <div className="bg-gray-50 p-4 rounded-lg text-center">
                <div className="text-[#2364a5] text-xl font-bold mb-2">1</div>
                <p className="text-sm text-gray-600">
                  We&apos;ll review your appointment request within 2 hours
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg text-center">
                <div className="text-[#2364a5] text-xl font-bold mb-2">2</div>
                <p className="text-sm text-gray-600">
                  Our team will call you to confirm the appointment
                </p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg text-center">
                <div className="text-[#2364a5] text-xl font-bold mb-2">3</div>
                <p className="text-sm text-gray-600">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex justify-center items-center px-6 py-3 bg-[#2364a5] text-white font-medium rounded-lg hover:bg-[#b8904a] transition-colors gap-2"
            >
            ...
            <a
              href="https://wa.me/919244966707?text=Hi,%20I%20just%20submitted%20an%20appointment%20request.%20I%20would%20like%20to%20know%20more%20about%20the%20treatment."
              target="_blank"
